...
@Deprecated(level = DeprecationLevel.WARNING, message = "There is a better version of TinyDB called MinDB",
    replaceWith = ReplaceWith("me.gumify.hiper.util.WeeDB(applicationContext)"))
